...
S:Lfont_manager.engine_font_manager_draw_char$ch$1$85({1}SC:U),B,1,4
S:Lfont_manager.engine_font_manager_draw_char$x$1$85({1}SC:U),B,1,5
S:Lfont_manager.engine_font_manager_draw_char$y$1$85({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_draw_char$pnt$1$86({2}DG,SC:U),R,0,0,[]
S:Lfont_manager.engine_font_manager_draw_char$tile$1$86({1}SC:U),R,0,0,[c]
F:G$engine_font_manager_draw_text$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfont_manager.engine_font_manager_draw_text$text$1$87({2}DG,SC:U),B,1,4
S:Lfont_manager.engine_font_manager_draw_text$x$1$87({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_draw_text$y$1$87({1}SC:U),B,1,7
S:Lfont_manager.engine_font_manager_draw_text$pnt$1$88({2}DG,SC:U),R,0,0,[]
S:Lfont_manager.engine_font_manager_draw_text$idx$1$88({1}SC:U),R,0,0,[b]
S:Lfont_manager.engine_font_manager_draw_text$tile$2$89({1}SC:S),R,0,0,[e]
F:G$engine_font_manager_draw_data$0$0({2}DF,SV:S),Z,0,5,0,0,0
S:Lfont_manager.engine_font_manager_draw_data$data$1$90({2}SI:U),B,1,4
S:Lfont_manager.engine_font_manager_draw_data$x$1$90({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_draw_data$y$1$90({1}SC:U),B,1,7
S:Lfont_manager.engine_font_manager_draw_data$pnt$1$91({2}DG,SC:U),R,0,0,[]
S:Lfont_manager.engine_font_manager_draw_data$idx$1$91({1}SC:U),B,1,-10
S:Lfont_manager.engine_font_manager_draw_data$tile$1$91({1}SC:S),R,0,0,[c]
S:Lfont_manager.engine_font_manager_draw_data$quotient$1$91({2}SI:U),B,1,-3
S:Lfont_manager.engine_font_manager_draw_data$remainder$1$91({1}SC:U),R,0,0,[e]
S:Lfont_manager.engine_font_manager_draw_data$hold$1$91({4}DA4d,SC:U),B,1,-9
...
S:Lfont_manager.engine_font_manager_draw_data_ZERO$data$1$95({2}SI:U),B,1,4
S:Lfont_manager.engine_font_manager_draw_data_ZERO$x$1$95({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_draw_data_ZERO$y$1$95({1}SC:U),B,1,7
S:Lfont_manager.engine_font_manager_draw_data_ZERO$pnt$1$96({2}DG,SC:U),R,0,0,[]
S:Lfont_manager.engine_font_manager_draw_data_ZERO$idx$1$96({1}SC:U),R,0,0,[b]
S:Lfont_manager.engine_font_manager_draw_data_ZERO$tile$1$96({1}SC:U),R,0,0,[e]
S:Lfont_manager.engine_font_manager_draw_data_ZERO$hold$1$96({4}DA4d,SC:U),B,1,-6
...
S:G$devkit_TILEtoADDR$0$0({2}DF,SV:S),C,0,0
...
S:G$devkit_UNSAFE_SMS_loadZX7compressedTilesatAddr$0$0({2}DF,SV:S),C,0,0
S:G$devkit_UNSAFE_SMS_loadZX7compressedTiles$0$0({2}DF,SV:S),C,0,0
S:G$devkit_UNSAFE_SMS_loadaPLibcompressedTilesatAddr$0$0({2}DF,SV:S),C,0,0
S:G$devkit_UNSAFE_SMS_loadaPLibcompressedTiles$0$0({2}DF,SV:S),C,0,0
...
S:G$devkit_SMS_addTwoAdjoiningSprites$0$0({2}DF,SV:S),C,0,0
S:G$devkit_SMS_addThreeAdjoiningSprites$0$0({2}DF,SV:S),C,0,0
...
S:G$devkit_SMS_configureTextRenderer$0$0({2}DF,SV:S),C,0,0
S:G$devkit_SMS_autoSetUpTextRenderer$0$0({2}DF,SV:S),C,0,0
S:G$devkit_SMS_decompressZX7$0$0({2}DF,SV:S),C,0,0
...
S:G$devkit_PORT_A$0$0({2}DF,SC:U),C,0,0
S:G$devkit_PORT_B$0$0({2}DF,SC:U),C,0,0
S:G$devkit_SMS_detectPaddle$0$0({2}DF,SC:U),C,0,0
S:G$devkit_SMS_readPaddle$0$0({2}DF,SC:U),C,0,0

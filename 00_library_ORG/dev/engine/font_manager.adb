...
S:Lfont_manager.engine_font_manager_draw_char$ch$1$67({1}SC:U),B,1,4
S:Lfont_manager.engine_font_manager_draw_char$x$1$67({1}SC:U),B,1,5
S:Lfont_manager.engine_font_manager_draw_char$y$1$67({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_draw_char$pnt$1$68({2}DG,SC:U),R,0,0,[]
S:Lfont_manager.engine_font_manager_draw_char$tile$1$68({1}SC:U),R,0,0,[c]
F:G$engine_font_manager_draw_text$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lfont_manager.engine_font_manager_draw_text$text$1$69({2}DG,SC:U),B,1,4
S:Lfont_manager.engine_font_manager_draw_text$x$1$69({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_draw_text$y$1$69({1}SC:U),B,1,7
S:Lfont_manager.engine_font_manager_draw_text$pnt$1$70({2}DG,SC:U),R,0,0,[]
S:Lfont_manager.engine_font_manager_draw_text$idx$1$70({1}SC:U),B,1,-1
S:Lfont_manager.engine_font_manager_draw_text$tile$2$71({1}SC:S),R,0,0,[b]
F:G$engine_font_manager_draw_data$0$0({2}DF,SV:S),Z,0,5,0,0,0
S:Lfont_manager.engine_font_manager_draw_data$data$1$72({2}SI:U),B,1,4
S:Lfont_manager.engine_font_manager_draw_data$x$1$72({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_draw_data$y$1$72({1}SC:U),B,1,7
S:Lfont_manager.engine_font_manager_draw_data$pnt$1$73({2}DG,SC:U),R,0,0,[]
S:Lfont_manager.engine_font_manager_draw_data$idx$1$73({1}SC:U),B,1,-6
S:Lfont_manager.engine_font_manager_draw_data$tile$1$73({1}SC:S),R,0,0,[c]
S:Lfont_manager.engine_font_manager_draw_data$quotient$1$73({2}SI:U),B,1,-2
S:Lfont_manager.engine_font_manager_draw_data$remainder$1$73({1}SC:U),R,0,0,[e]
S:Lfont_manager.engine_font_manager_draw_data$hold$1$73({4}DA4d,SC:U),B,1,-10
...
S:Lfont_manager.engine_font_manager_draw_zero$data$1$77({2}SI:U),B,1,4
S:Lfont_manager.engine_font_manager_draw_zero$x$1$77({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_draw_zero$y$1$77({1}SC:U),B,1,7
S:Lfont_manager.engine_font_manager_draw_zero$pnt$1$78({2}DG,SC:U),R,0,0,[]
S:Lfont_manager.engine_font_manager_draw_zero$idx$1$78({1}SC:U),R,0,0,[b]
S:Lfont_manager.engine_font_manager_draw_zero$tile$1$78({1}SC:U),R,0,0,[e]
S:Lfont_manager.engine_font_manager_draw_zero$hold$1$78({4}DA4d,SC:U),B,1,-6
